...
interface InitializeCartAction extends Action<'INITIALZE_CART'> {
  payload: {
...
const reducer = (
  ...
  } else if (action.type === 'INITIALZE_CART') {
    return {
      ...state,
...
const AppStateProvider: React.FC = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (cart) {
      dispatch({ type: 'INITIALZE_CART', payload: { cart: JSON.parse(cart) } });
    }
  }, []);
